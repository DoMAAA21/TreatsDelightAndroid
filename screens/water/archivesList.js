...
import { restoreWater } from '../../store/reducers/water/waterSlice';

const { width } = Dimensions.get('screen');

const ArchivesList = ({ waters }) => {
    ...
    const confirmDelete = (id) => {
        Alert.alert(
          'Confirm Delete',
          'Are you sure you want to restore this water?',
          [
            {
              text: 'Cancel',
              style: 'cancel',
            ...
            {
              text: 'Restore',
              onPress: () => dispatch(restoreWater(id)),
              style: 'destructive',
            },
          ],
          { cancelable: false }
